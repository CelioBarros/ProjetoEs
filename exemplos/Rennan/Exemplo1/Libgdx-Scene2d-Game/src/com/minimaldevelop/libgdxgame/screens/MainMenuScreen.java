...
public class MainMenuScreen implements Screen {
	...
	TextButton recordeButton;
	TextButton ajudaButton;
...
//		Table.drawDebug(stage);
	...
	public void show() {
		...
		ajudaButton = new TextButton("Ajuda", Assets.skin);
		recordeButton = new TextButton("Recorde", Assets.skin);
...
//		table.debug(); 
		...
		table.row();
		table.add(ajudaButton).width(150).height(50).padTop(10);
		table.row();
		table.add(recordeButton).width(150).height(50).padTop(10);
		table.row();
