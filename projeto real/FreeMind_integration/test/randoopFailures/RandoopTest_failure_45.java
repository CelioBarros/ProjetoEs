...
public class RandoopTest_failure_45 extends TestCase {

  public static boolean debug = false;

  public void test1() throws Throwable {

    if (debug) System.out.printf("%nRandoopTest_failure_45.test1");
    ...
    freemind.view.MapModule var6 = var3.getMapModule();
