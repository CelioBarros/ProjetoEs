...
public class RandoopTest_failure_97 extends TestCase {

  public static boolean debug = false;

  public void test1() throws Throwable {

    if (debug) System.out.printf("%nRandoopTest_failure_97.test1");
    ...
    freemind.modes.Mode var9 = var3.getMode();
    freemind.modes.MindMap var10 = var3.getMap();
